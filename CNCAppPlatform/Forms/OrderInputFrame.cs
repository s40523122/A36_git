    ...
    public partial class OrderInputFrame : Form
    {
        ...
        private void btnAppend_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                // 將數字分割成兩個8位的部分
                byte register1 = (byte)(number >> 8); // 右移8位，得到高8位
                byte register2 = (byte)(number & 0xFF); // 用0xFF（二進位表示為11111111）進行AND運算，得到低8位

                // 寫入Register1
                Form1.axActUtlType.SetDevice("D1353", register1);
                // 寫入Register2
                Form1.axActUtlType.SetDevice("D1352", register2);
